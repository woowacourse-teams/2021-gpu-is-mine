...
INSERT INTO gpu(id, gpu_name, model_name, running, teraflop, lab_id) VALUES(2, 'GPU서버2', 'Nvidia', true, 800, 1);
...
INSERT INTO job(id, name, waiting, lab_user_id, gpu_id) VALUES(3, '예약3', true, 1, 2);
INSERT INTO job(id, name, waiting, lab_user_id, gpu_id) VALUES(4, '예약4', true, 1, 1);
