...
public class GpuServerFixtures {
    ...
    public static final String GPU_BOARD_NAME = "BOARD_NAME";
    public static final Long GPU_BOARD_PERFORMANCE = 10L;

    public static final String GPU_SERVER_NAME = "SERVER_NAME";
    public static final Long GPU_SERVER_MEMORY_SIZE = 10L;
    public static final Long GPU_SERVER_DISK_SIZE = 10L;
